...
export const TAG_SECTIONS = {
  ...
  "규제·당국": [
    ...
    "약물감시", "보건 정책", "의약품 규제", "보건부", "품질", "임상", "규제", "BKPM", "보건부 정책", "BPJS(국민건강보험)", "Kementerian Kesehatan", "전통의약", "대체의학", "바이오", "의료기기", "헬스케어 시스템", "일반공중보건", "신약 동향"
  ],
  "산업·시장": [
  ...
  "제품·치료제": [
    "신약", "바이오시밀러", "바이올로직스", "제네릭 의약품", "전통 의약품", "건강 보조제", "의료기기", "전문 의약품", "일반의약품 (OTC)", "화장품", "더마", "백신", "품", "임상", "허가", "신약 동향", "Fexuprazan (펙수프라잔)", "Envlo (SGLT-2)", "Crezet (복합제)", "Letybo (보툴리눔 톡신)", "Selatoxin (셀라톡신)", "Clinical Trial / CTA / PMS", "Clinical Waiver", "Non-Inferiority Margin", "Fast Track Approval"
  ],
  "경쟁사·주주": [
